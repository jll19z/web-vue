  ...
  <div>
    ...
    >
      <el-form-item label="员工号">
        <el-input
          v-model="workaddQuery.sid"
          placeholder="请输入名称"
        ></el-input>
      </el-form-item>
            <el-form-item label="名称">
        <el-input
          v-model="workaddQuery.sname"
          placeholder="请输入名称"
        ></el-input>
      </el-form-item>
    ...
    >
     <el-table-column prop="wid" label="序号" width="70" align="center">  </el-table-column>
      ...
      <!-- <el-table-column prop="workdate" label="月份" width="120"/> -->
      <el-table-column prop="starttime" label="开始时间" width="100" />
      <el-table-column prop="endtime" label="结束时间" width="100" />
     <el-table-column prop="addmoney" label="工资补贴" width="100" />
  ...
  if(sname == "ljl" || sname == "提莫"){
   ...
   this.userflag=false;
    ...
    getList(page=1) {
        this.page=page;
      workaddAPI
        .getListPage(this.page, this.limit, this.workaddQuery)
        .then((resp) => {
          //resp接口返回的数据
          // console.log(resp);
