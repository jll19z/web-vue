...
<div>
<div class='' v-if="userflag">
<el-form ref="form" :model="form" label-width="80px" style="margin-top:50px">
  <el-form-item label="员工号">
    <el-input v-model="workadd.sid"></el-input>
  </el-form-item>
  <el-form-item label="员工姓名">
    <el-input v-model="workadd.sname"></el-input>
  </el-form-item>
<el-form-item label="加班月份">
    <el-input v-model="workadd.workdate"></el-input>
  </el-form-item>


  <el-form-item label="起始时间">
    <el-date-picker
      v-model="workadd.starttime"
      type="datetime"
      placeholder="选择日期时间">
    </el-date-picker>
  </el-form-item>
...
<el-form-item label="加班工资">
    <el-input v-model="workadd.addmoney"></el-input>
  </el-form-item>
...
import workaddAPI from "@/api/workadd.js";
...
methods: {
  ...
  userLog(utype,utable,info){
      ...
      // 保存
        saveData() {
            workaddAPI.save(this.workadd).then((resp) => {//添加成功
                //提示信息
                this.$message({
                    message: "添加记录成功",
                    type: "success",
                ...
                //回到讲师列表 路由跳转
                  this.userLog('添加','workadd','(添加加班情况操作)')
                this.$router.push({path: '/workadd/table'})
            });
        },
